...
// :page-aliases: general::exp-governance-policy-library-apply.adoc
...
// For comprehensive, scope-driven governance across multiple services, use xref:governance-create-strategy.adoc[governance strategies] instead.
