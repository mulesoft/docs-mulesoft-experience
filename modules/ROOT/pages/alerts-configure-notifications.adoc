...
:keywords: alerts, notifications, configure alerts, alert target, manage alerts, anypoint platform, monitoring
:page-aliases: general::exp-alerts-configure-notifications.adoc
...
* The MuleSoft Slack app installed in your workspace (see xref:slack-integrate.adoc[] for installation steps)
