...
:page-aliases: general::exp-akamai-risk-correlation.adoc
...
For credential and role details, see xref:scanners-prerequisites-reference.adoc[].
...
Before you set up the scanner, review the prerequisites for Akamai scanners in xref:scanners-prerequisites-reference.adoc[].
...
For common tab behavior across scanners, see xref:scanners-view-details.adoc[].
