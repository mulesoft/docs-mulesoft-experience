...
:page-aliases: gateway::llm-proxy-semantic-service.adoc, gateway::flex-gateway-llm-proxy-semantic-service.adoc, general::exp-services-add-semantic.adoc, general::model-proxy-semantic-service.adoc
...
. From *Semantic Service Setup*, click the three-dots menu (image:gateway::image$three-dots-menu.png[3%,3%]) of the semantic service you want to edit.
