...
:page-aliases: general::exp-scanners-add-from-providers.adoc
...
For how provider connection and catalogs fit together, see xref:services-connect-providers-to-add.adoc[] and xref:services-add-to-portfolio.adoc[].
...
For provider-specific roles, credentials, and permission scopes, see xref:scanners-prerequisites-reference.adoc[].
...
For setup details, policy behavior, and result interpretation, see xref:akamai-risk-correlation.adoc[].
...
For ongoing operations (pause, edit, or delete), see xref:scanners-manage.adoc[].
