...
:page-aliases: general::exp-governance-work-with-strategies.adoc
...
* Create strategies for compliance validation or runtime enforcement. See xref:governance-create-strategy.adoc[].
* Manage strategies by updating scope, rules, status, and priority. See xref:governance-manage-strategies.adoc[].
* Monitor token usage in *Governance* > *Cost Management*. See xref:governance-view-cost-and-token-usage.adoc[].
* Review conformance reporting for xref:index.adoc[supported catalog types].
* Apply policies to services from *Portfolio*. See xref:services-view-details.adoc[].
