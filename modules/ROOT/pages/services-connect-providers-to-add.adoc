...
:page-aliases: general::exp-services-connect-providers-to-add.adoc
...
Start the flow from *Home* or from a specific catalog in *Portfolio*. To see how this flow relates to manual registration, see xref:services-add-to-portfolio.adoc[]. To create and tune scanners, see xref:scanners-add-from-providers.adoc[].
