...
:page-aliases: general::exp-services-view-details.adoc
...
Labels and fields inside a tab can differ by service type and release. For end-to-end portfolio tasks that reference these tabs, see xref:index.adoc[].
tab can differ by service type and release. For end-to-end portfolio tasks that reference these tabs, see xref:index.adoc[].
...
[NOTE]
====
* *Instances* tab is available on *Agents*, *MCP Servers*, and *APIs*; *Model Proxies* and *Gateways* do not include an *Instances* tab. See xref:index.adoc[].

* *Conformance* on the detail page aligns with *Agents*, *APIs*, and *MCP Servers*; for gateways, compliance work is framed through *Governance* and related flows at the scope the system supports. See xref:index.adoc[].
====
