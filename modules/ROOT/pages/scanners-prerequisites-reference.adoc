...
:page-aliases: general::exp-scanners-prerequisites-reference.adoc
...
*Setup:* Existing services in *Portfolio* catalogs for correlation targets; create a connected app in MuleSoft; configure Akamai-side sync with the MuleSoft connected app. For details, see xref:akamai-risk-correlation.adoc[].
