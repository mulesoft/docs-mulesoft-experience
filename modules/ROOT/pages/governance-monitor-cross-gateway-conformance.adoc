...
:page-aliases: general::exp-governance-monitor-cross-gateway-conformance.adoc
...
* xref:services-view-details.adoc[Connect to one or more third-party providers] to enable cross-gateway governance.
* xref:governance-create-strategy.adoc[Create a governance strategy] that evaluates the APIs you want to monitor.
